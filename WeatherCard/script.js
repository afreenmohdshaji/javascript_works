    ...
    let htmlData=`
                ...
                <div class="card p-5">
                    ...
                    <div>
                      ...
                      <button type="submit" onclick="fetchDetail()">fetch</button> 
                    </div>
                </div>
    `
...
fetch("https://api.openweathermap.org/data/2.5/weather?units=metric&q=kakkanad&appid=8f9164d0bb1a347b51a7d0e25e247b6c").then(res=>res.json()).then(data=>displayWeather(data))
